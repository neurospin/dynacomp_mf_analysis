...
SUBJECTS_DIR = '/volatile/omar/Documents/projects/meg_mf_analysis/data/zilber_dataset'
DATASET_DIR  = '/volatile/omar/Documents/projects/meg_mf_analysis/data/zilber_dataset'

def get_info(dataset_dir = SUBJECTS_DIR, subjects_dir = SUBJECTS_DIR):
    """
    Args:
